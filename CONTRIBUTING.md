Contributing to TGIS Core
============================

The TGIS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TGIS Core project, and is not to be
confused with overall TGIS Network Protocol consensus changes.

Whether a pull request is merged into TGIS Core rests with the project merge
...
Patches that change TGIS consensus rules are considerably more involved than
...
Where a patch set proposes to change the TGIS consensus, it must have been
...
The project leader is the release manager for each TGIS Core release.
