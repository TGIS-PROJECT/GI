...
This mechanism has been integrated into Bitcore-Node-TGIS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TGIS-PROJECT/insight-api-tgis#web-socket-api](https://github.com/TGIS-PROJECT/insight-api-tgis#web-socket-api) 
* API: [https://github.com/TGIS-PROJECT/insight-api-tgis#swifttx-transactions](https://github.com/TGIS-PROJECT/insight-api-tgis#swifttx-transactions) 
...
By default, the TGIS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TGIS Core daemon:
