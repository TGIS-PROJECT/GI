...
In order to support loading of multiple wallets in tgis-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tgis.cpp.
...
Changes to tgis.cpp
----------------------
tgis.cpp is the entry point into tgis-qt, and as such, will require some minor modifications to provide hooks for
