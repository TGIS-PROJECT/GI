...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Tgis Core tgis-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tgis-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tgis transaction") + "\n" +
                               "  tgis-tx [options] -create [commands]   " + _("Create hex-encoded tgis transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tgis transaction
