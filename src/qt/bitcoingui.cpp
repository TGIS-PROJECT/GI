                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TGIS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TGIS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tgis: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TGIS Core"), this);
    aboutAction->setStatusTip(tr("Show information about TGIS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TGIS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TGIS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TGIS addresses"));
    ...
    openAction->setStatusTip(tr("Open a TGIS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TGIS Core help message to get a list with possible TGIS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TGIS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TGIS network", "", count));
}
...
{
    QString strTitle = tr("TGIS Core"); // default title
