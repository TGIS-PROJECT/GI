...
This means one can have an always-on tgisd instance running, and another local tgisd/tgis-qt instance which connects to this node and receives blocks from it.
