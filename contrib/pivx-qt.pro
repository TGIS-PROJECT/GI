...
RESOURCES += src/qt/tgis.qrc src/qt/tgis_locale.qrc

TRANSLATIONS += src/qt/locale/tgis_bg.ts \
                src/qt/locale/tgis_de.ts \
                src/qt/locale/tgis_en.ts \
                src/qt/locale/tgis_es.ts \
                src/qt/locale/tgis_fi.ts \
                src/qt/locale/tgis_fr.ts \
                src/qt/locale/tgis_it.ts \
                src/qt/locale/tgis_ja.ts \
                src/qt/locale/tgis_pl.ts \
                src/qt/locale/tgis_pt.ts \
                src/qt/locale/tgis_ru.ts \
                src/qt/locale/tgis_sk.ts \
                src/qt/locale/tgis_sv.ts \
                src/qt/locale/tgis_vi.ts \
                src/qt/locale/tgis_zh_CN.ts \
                src/qt/locale/tgis_zh_TW.ts
